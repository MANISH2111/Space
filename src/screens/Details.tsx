          ...
          <FlexRow justifyContent={'space-between'}>
            <FlexCol>
                ...
                <CText fSize={15}>
                     Name
                     <Gutter hSpacing={2}/> 
                     <CText fSize={13} color='grey'>{launch_site.site_name}</CText>  
                </CText>
                <CText fSize={15}>
                    Location
                    <Gutter hSpacing={1}/> 
                    <CText fSize={13} color='grey' align='center'>{launch_site.site_name_long}</CText>  
                </CText>
          ...
          <FlexRow justifyContent={'space-between'}>
            <FlexCol>
                ...
                <CText fSize={15}>
                   Success
                     <Gutter hSpacing={1}/> 
                     <CText fSize={13} color='grey'>{launch_success?'Success':'Failure'}</CText>  
                </CText>
            </FlexCol>
          </FlexRow>
        </Container>
          ...
          <FlexRow justifyContent={'space-between'}>
            <FlexCol>
                ...
                <CText fSize={15}>
                   Name
                     <Gutter hSpacing={2}/> 
                     <CText fSize={13} color='grey'>{rocket.rocket_name}</CText>  
                </CText>

                <CText fSize={15}>
                  Type
                     <Gutter hSpacing={2.4}/> 
                     <CText fSize={13} color='grey'>{rocket.rocket_type}</CText>  
                </CText>
